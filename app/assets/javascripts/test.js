...
$("select.changeMe").each(function(){
	...
	var gddTop = '<div style="width:'+ 198 + 'px;" class="selectME" tabindex="0"><div class="middle">';
	//get the default selected option
	var whatSelected = $(curSel).children('option:selected').text();
	//write the default
	var gddFirst = '<div class="first"><span class="selectME gselected" style="width:'+ gddWidth2 +  'px;">'+ whatSelected +'</span><span id="arrowImg"></span><div class="clears"></div></div><ul class="selectME" style="width:'+ 198 +  'px;">';
